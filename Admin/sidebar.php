...
$librarian_email = "";
$librarian_pic = "loa_logo.png"; // fallback image

if (isset($_SESSION['librarian_id'])) {
    $id = $_SESSION['librarian_id'];
    $query = mysqli_query($conn, "SELECT Name, Email, picture FROM librarian WHERE id='$id' LIMIT 1");
...
<div class="sidebar" id="sidebar">
    ...
    <ul class="menu">
        ...
        <li class="<?php echo ($current_page == 'return-books.php') ? 'active' : ''; ?>">
            <a href="return-books.php"><i class="fas fa-undo"></i><span class="menu-text">RETURN BOOKS</span></a>
        </li>
        <li class="<?php echo ($current_page == 'book-transaction.html') ? 'active' : ''; ?>">
            <a href="book-transaction.html"><i class="fa-solid fa-book-open-reader"></i><span class="menu-text">BOOK TRANSACTION</span></a>
        </li>
